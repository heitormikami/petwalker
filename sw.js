const CACHE_NAME = 'petwalker-v37';
const ASSETS = [
  './',
  './index.html',
  './css/styles.css',
  ...
  './src/domain/models.js?v=37',
  './src/services/storage.js',
  './src/services/storage.js?v=37',
  './src/services/security.js',
  './src/services/security.js?v=37',
  './src/services/googleSync.js',
  './src/services/googleSync.js?v=37',
  './src/services/pushService.js',
  './src/services/pushService.js?v=37',
  './manifest.json',
  './assets/icon-192.png',
  './assets/icon-512.png',
